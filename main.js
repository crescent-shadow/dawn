...
(function (ResultsEnum) {
    ResultsEnum[ResultsEnum["InProgress"] = 0] = "InProgress";
    ResultsEnum[ResultsEnum["Victory"] = 1] = "Victory";
    ResultsEnum[ResultsEnum["Defeat"] = 2] = "Defeat";
})(ResultsEnum = exports.ResultsEnum || (exports.ResultsEnum = {}));
...
var mode_view_1 = __webpack_require__(19);
var grid_view_1 = __webpack_require__(20);
var status_1 = __webpack_require__(22);
var results_enum_1 = __webpack_require__(3);
var Game = /** @class */ (function () {
    ...
    Game.prototype.defeat = function () {
        ...
        this.status.updateResult(results_enum_1.ResultsEnum.Defeat);
    };
    Game.prototype.victory = function () {
        this.gridView.freeze();
        this.status.timer.stop();
        this.status.updateResult(results_enum_1.ResultsEnum.Victory);
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var $ = __webpack_require__(0);
var feather = __webpack_require__(2);
var Header = /** @class */ (function () {
    ...
    Header.prototype.generateLogo = function () {
        var icon = feather.icons.moon.toSvg();
        this.$logo = $('<div>')
...
var ModeView = /** @class */ (function () {
    ...
    ModeView.prototype.getSelector = function (mode) {
        var button = $('<button />');
        var icon = feather.icons[mode.icon].toSvg();
...
var Cell = /** @class */ (function () {
    ...
    Cell.prototype.flag = function (toggle) {
        var flagIcon = feather.icons.flag.toSvg();
...
var events_1 = __webpack_require__(1);
var results_enum_1 = __webpack_require__(3);
var timer_1 = __webpack_require__(23);
var Status = /** @class */ (function () {
    function Status() {
        this.canvas = $('<div>');
        this.stateElements = {};
        this.generateRestartButton();
        var $modeInfo = this.generateModeInfoElement();
        var $resultInfo = this.generateResultInfoElement();
        this.canvas
            .addClass('status')
    ...
    Status.prototype.init = function (mines) {
        this.initState(mines);
        this.toggleRestartButton(true);
        this.updateResult(results_enum_1.ResultsEnum.InProgress);
        this.timer.tick();
    };
    // Restart Button
    Status.prototype.generateRestartButton = function () {
        var label = $("<span>RESTART</span>");
        var icon = feather.icons['rotate-cw'].toSvg();
    ...
    // Mode Info
    Status.prototype.generateModeInfoElement = function () {
        var $modeInfo = $('<div>').addClass('status-mode-info');
    ...
    Status.prototype.generateStatesElements = function () {
        ...
        var $stateRoot = $('<div>').addClass(stateClass);
    ...
    // Result Info
    Status.prototype.generateResultInfoElement = function () {
        var $resultInfo = $('<div>').addClass('status-result-info');
    ...
    Status.prototype.updateResult = function (result) {
        var iconInProgress = feather.icons['more-horizontal'].toSvg();
        var iconVictory = feather.icons['check-square'].toSvg();
        var iconDefeat = feather.icons['x-square'].toSvg();
        this.$result
            .empty()
        ...
        switch (result) {
            case results_enum_1.ResultsEnum.InProgress:
                this.$result
                    .addClass('status-result-in-progress')
                    .append(iconInProgress)
                    .append(' PROGRESS');
                break;
            case results_enum_1.ResultsEnum.Victory:
                this.$result
                    .addClass('status-result-victory')
                    .append(iconVictory)
                    .append(' VICTORY');
                break;
            case results_enum_1.ResultsEnum.Defeat:
                this.$result
    ...
    Status.prototype.generateTimerElement = function () {
...
var Timer = /** @class */ (function () {
    ...
    Timer.prototype.display = function () {
        var m = Math.floor((this.value % 3600) / 60);
        var s = Math.max(Math.floor((this.value % 3600) % 60), 0);
